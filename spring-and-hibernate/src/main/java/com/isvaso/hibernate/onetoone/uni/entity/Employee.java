package com.isvaso.hibernate.onetoone.uni.entity;
...
public class Employee {
    ...
    public Employee(String name, String surname, String department,
                    int salary, Detail employeeDetail) {
        this.name = name;
    ...
    public boolean equals(Object object) {
        ...
        return id == employee.getId()
                ...
                && employeeDetail.equals(employee.getEmployeeDetail());
    }
